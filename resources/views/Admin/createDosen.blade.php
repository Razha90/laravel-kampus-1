...
<h1>Create New Data Dosen</h1>
<form class="row g-3" action="{{url('/admin/dosen')}}" method="POST">
  @csrf
  @if (session('success'))
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control  @error('nama') is-invalid @enderror" id="validationServer01" placeholder="Razha Example" required name="nama">
  ...
  <div class="col-md-4">
    ...
    <div class="input-group has-validation">
      ...
      <input type="text" class="form-control  @error('email') is-invalid @enderror" id="validationServerEmail" aria-describedby="inputGroupPrepend3 validationServerEmailFeedback" required placeholder="example@dsd.com" name="email">
  ...
  <div class="col-md-3">
    <label for="validationServer05" class="form-label">NIM</label>
    <input type="text" class="form-control  @error('nim') is-invalid @enderror" id="validationServer05" aria-describedby="validationServer05Feedback" required name="nim" placeholder="02323">
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control  @error('phone') is-invalid @enderror" id="validationServer03" aria-describedby="validationServer03Feedback" required name="phone" placeholder="08454546345">
