							...
							<form role="form" v-bind:action="urlUpdate" method="POST">
								...
								<div class="box-body">
									<div class="form-group">
										...
										<input type="number" class="form-control" id="nim" placeholder="NIM" v-model="nim" name="nim" />
									</div>
									<div class="form-group">
      ...
      <i class="fa fa-spinner fa-spin"></i> Loading...
		...
		<script>
			  ...
			  $('#myModal').modal('show');
                    ...
                    this.isLoading = true;
			                let url = `{{ url('/api/data-mahasiswa') }}?page=` + id;
			                axios.get(url)
			                    .then(resp => {
			    ...
			    this.nim = id;
			    var url = "{{url('/admin/mahasiswa')}}" + "/" + id;
			    this.urlUpdate= "{{ url('/admin/mahasiswa') }}" + "/" + id;
			    axios.get(url)
			        .then(resp => {
