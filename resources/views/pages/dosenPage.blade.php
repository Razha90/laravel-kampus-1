  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="{{ url('/dosen') }}">Dosen</a></li>
                    ...
                    <form role="form" v-bind:action="urlUpdate" method="POST">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="id" placeholder="id" v-model="id" name="id">
                            </div>                           
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" placeholder="Nama" v-model="nama" name="nama">
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" id="email" placeholder="Email" v-model="email" name="email">
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone</label>
                                <input type="number" class="form-control" id="phone" placeholder="Phone Number" v-model="phone" name="phone">
                            </div>
                        </div>
  ...
  $('#myModal').modal('show');
        ...
        var vue = new Vue({
            ...
            getData: function(id=0) {
              this.isLoading = true;
                let url = `{{ url('/api/data-dosen') }}?page=` + id;
                axios.get(url)
                    .then(resp => {
                        console.log(resp);
    ...
    this.id = id;
    var url = "{{url('/admin/dosen')}}" + "/" + id;
    this.urlUpdate= "{{ url('/admin/dosen') }}" + "/" + id;
    axios.get(url)
        .then(resp => {
